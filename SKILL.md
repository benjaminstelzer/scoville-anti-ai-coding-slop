...
description: >-
  ...
  test, or documentation activity for its own sake.
---

# Scoville Engineering Guardrail

Follow system, user, safety, runtime, and repository instructions before this
skill. Apply Scoville only where those sources leave the workflow open. Never
create a competing plan, log, validation ceremony, or source of truth.
