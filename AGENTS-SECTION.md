...
plans, writes, fixes, refactors, tests, reviews, or removes code or changes
engineering artifacts.

Follow system, user, safety, and runtime rules before these instructions.
Let explicit user instructions and other repository directives override these
defaults concern by concern; they never override higher-priority instructions,
safety, integrity, or truthful evidence.
